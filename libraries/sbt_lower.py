...
SUBTIT_X = TITLE_X +250
SUBTIT_Y = TITLE_Y + 223
SUBTIT_CAPS = True

TITLE_FONT_SIZE  = 55
SUBTIT_FONT_SIZE = 22 # 20
DFONT_FONT_SIZE  = 25 # 20
...
GT_TICKS_FONT_SIZE =  14  # 36  # 20

GT_BLOCK_INFO_COLOR = '#001122'  # '#1B2C3E'  # T_COLOR_6  # new
GT_BLOCK_FONT_COLOR = 'white'
GT_BLOCK_LBL_FS = 50  # 30  # 20
GT_BLOCK_NUM_FS = 50  # 30  # 20
GT_BLOCK_DX = 6

GT_COLOR_NEG = '#FF657F'
GT_COLOR_POS = '#65E0FF'  # T_COLOR_6  # new
GT_TRACE_WIDTH = 3

GT_INFO_52M = False

# graphtime
GT_MARGINS_LRTBPAD = 0, 0, 0, 0, 0
GT_LEGEND_X = 1.02
GT_LEGEND_Y = 1
GT_LEGEND_FS = 18
